...
<head>
	...
	<link rel="shortcut icon" href="http://cloud-bbx.pw/bbx.png">
	<meta name="application-name" content="BBX - Whois Lookup" />
	<meta name="author" content="Mr.Fn4ticHz" />
	<meta name="generator" content="RamaGans ID" />
	<link rel="stylesheet" type="text/css" href="css/main.css" />
	<title>BBX - Whois Lookup</title>
...
<div id="wrapper">
	<div id="main">
		...
		<div id="decrypt" class="box">
			<p class="title"><strong>BBX - Whois Lookup</strong></p>
		<div>
		<div>
				<div class="setengah">
					<div class="form-field">
						...
						<input maxlength="64" type="text" id="domain" name="domain" value="" style="width:150px;" placeholder="domain.com" />
					</div>
				</div>
				<div class="setengah">
					<div class="form-field">
						<label for="kodemaho">Captcha : </label>
						<span id="nohope"><img src="https://brebes-bx.org/.well-known/acme-challenge/whois-master/random.php" /></span>
...
<center></center><div id="endofworld">&copy;2022 <a href="https://brebes-bx.org" target="_blank" title="Brebes Black Xploit">Brebes Black Xploit</a> - Fixed & Mixed by <a href="https://BBX-HOST.my.id" target="_blank" title="BBX-HOST">RamaGans ID</a></div></center>
</body>
</html>